				...
				<div class="row align-items-top">
					<div class="col-lg-6 col-md-12 p-2">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="last_name" autocomplete="on" class="form-control" v-model="order_data.last_name" :class="[ order_data_errors.last_name ? 'is-invalid' : '' ]">
								<div class="invalid-feedback" v-if="order_data_errors.last_name">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="first_name" autocomplete="on" class="form-control" v-model="order_data.first_name" :class="[ order_data_errors.first_name ? 'is-invalid' : '' ]">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="middle_name" autocomplete="on" class="form-control" v-model="order_data.middle_name" :class="[ order_data_errors.middle_name ? 'is-invalid' : '' ]">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="email" autocomplete="on" class="form-control" v-model="order_data.email" :class="[ order_data_errors.email ? 'is-invalid' : '' ]">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="tel" name="phone" autocomplete="on" class="form-control" v-mask="'+7 (###) ###-##-##'" v-model="order_data.phone" :class="[ order_data_errors.phone ? 'is-invalid' : '' ]">
					...
					<div class="col-lg-6 col-md-12 p-2">
						...
						<div class="row align-items-center m-2">
							...
							<div class="col-8">
								<select name="delivery_method" class="form-select" v-model="order_data.delivery_method" :class="[ order_data_errors.delivery_method ? 'is-invalid' : '' ]">
						...
						<div v-if="order_data.delivery_method == 'pochta'" class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="postal_code" autocomplete="on" class="form-control" v-mask="'######'" v-model="order_data.postal_code" :class="[ order_data_errors.postal_code ? 'is-invalid' : '' ]">
						...
						<div v-if="order_data.delivery_method == 'pochta'" class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="region" autocomplete="on" class="form-control" v-model="order_data.region" :class="[ order_data_errors.region ? 'is-invalid' : '' ]">
						...
						<div v-if="order_data.delivery_method == 'pochta' || order_data.delivery_method == 'cdek'" class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="city" autocomplete="on" class="form-control" v-model="order_data.city" :class="[ order_data_errors.city ? 'is-invalid' : '' ]">
						...
						<div v-if="order_data.delivery_method == 'pochta'" class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="address" autocomplete="on" class="form-control" v-model="order_data.address" :class="[ order_data_errors.address ? 'is-invalid' : '' ]">
						...
						<div v-if="order_data.delivery_method == 'cdek'" class="row align-items-center m-2">
							...
							<div class="col-8">
								<input type="text" name="cdek_address" autocomplete="on" class="form-control" v-model="order_data.cdek_address" :class="[ order_data_errors.cdek_address ? 'is-invalid' : '' ]">
					...
					<div class="col-12 p-2">
						<div class="row align-items-center m-2">
							...
							<div class="col-12">
								<textarea name="note" autocomplete="on" rows="4" class="form-control" v-model="order_data.note" :class="[ order_data_errors.note ? 'is-invalid' : '' ]"></textarea>
