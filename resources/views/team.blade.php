...
@section('title', 'Команда'.' - '.config('app.name'))
...
<div class="team">
	<div class="row gy-5">
		<div class="col-lg-6 col-md-12">
			<div class="team-member">
				<div class="member-photo">
					<img src="{{ asset('images/team/ikonnikova.jpg') }}" class="w-100 img-thumbnail" />
				</div>
		...
		<div class="col-lg-6 col-md-12">
			<div class="team-member">
				<div class="member-photo">
					<img src="{{ asset('images/team/balandina.jpg') }}" class="w-100 img-thumbnail" />
				</div>
		...
		<div class="col-lg-6 col-md-12">
			<div class="team-member">
				<div class="member-photo">
					<img src="{{ asset('images/team/semin.jpg') }}" class="w-100 img-thumbnail" />
				</div>
		...
		<div class="col-lg-6 col-md-12">
			<div class="team-member">
				<div class="member-photo">
					<img src="{{ asset('images/team/kostrikov.jpg') }}" class="w-100 img-thumbnail" />
				</div>
